...
//Bu Botun Düzenleyicisi & Geliştiricisi İtemsatış: AlienShop & Alien#8008

client.on("ready", () => {
	console.log(" ")
	console.log("-------------------------------------------------------------------------------")
	console.log("Bu Botun Yapımcısı İtemsatış: AlienShop Discord: Alien#8008");
	console.log("Bu Botun Düzenleyicisi & Geliştiricisi İtemsatış: AlienShop & Alien#8008");
	console.log("-------------------------------------------------------------------------------")
	console.log(" ")
...
//Bu Botun Yapımcısı İtemsatış: AlienShop Discord: Alien#8008
//Bu Botun Düzenleyicisi & Geliştiricisi İtemsatış: AlienShop & Alien#8008
...
setInterval(function() {
	console.log("-------------------------------------------------------------------------------");
	console.log("Bu Botun Yapımcısı İtemsatış: AlienShop Discord: Alien#8008");
	console.log("Bu Botun Geliştiricisi İtemsatış: AlienShop Discord: Alien#8008");
	console.log("-------------------------------------------------------------------------------");
},1000000);
